                                ...
                                <ul class="mega-dropdown-menu row">
                                    ...
                                    <li class="col-lg-3 col-xlg-3 m-b-30">
                                        ...
                                        <ul class="list-style-none">
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Другая ссылка</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Другая ссылка</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Другая ссылкаk</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Другая ссылка</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Другая ссылка</a></li>
                                        </ul>
                                    </li>
